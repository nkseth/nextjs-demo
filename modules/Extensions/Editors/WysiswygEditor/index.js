...
import WysiswygEditorExample from './demo/WysiswygEditorExample';
...
const demos = [
  {
    label: 'WYSISWYG Editor',
    link: 'wysisiwyg-editor',
    component: <WysiswygEditorExample />,
    filename: './WysiswygEditorExample.txt',
  },
];
